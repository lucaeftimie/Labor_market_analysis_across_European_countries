...
#windows
  setwd("C:\\Users\\lucac\\Desktop\\licenta\\cod\\oltp_to_olap\\")
...
specific_names_file_path <- paste(getwd(), "/data/metadata/specific_names.xlsx", sep="")
...
legend <- openxlsx::read.xlsx(paste(getwd(), "/data/metadata/legend.xlsx", sep=""))

# Path of files to modify
dir_files <- paste(getwd(), "/data/to_be_cleaned/modified", sep = "")
...
header <- c("region_id", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024" )
pop_tot_20_64 <- rbind(header, pop_tot_20_64)
...
create_csvs(all_dfs, getwd(), TRUE)
